       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">เหตุผลการไม่อนุมัติ</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
		...
		?>
            <form method="post" action="update_club_no.php" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="club_id" value="<?=$row[club_id];?>">
              <h4 class="form-signin-heading" align="center"></h4>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <textarea name="club_detail" class="form-control" rows="3"><?=$row[club_detail];?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
