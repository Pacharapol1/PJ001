                      ...
                      <div class="col-sm-5">
                          <select name="emp_id1" class="form-control" required>
                            ...
                            <?
							  ...
							  ?>
                                <option value="<?=$row_dep[emp_id];?>" <? if($row_dep[emp_id] == $row[emp_id1]){echo 'selected'; } ?>><?=$row_dep[title_name];?><?=$row_dep[emp_name];?> <?=$row_dep[emp_surname];?></option>
                            <?  } ?>
                          </select>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <select name="emp_id2" class="form-control" required>
							...
							?>
                            		<option value="<?=$row_saka[emp_id];?>" <? if($row_saka[emp_id] == $row[emp_id2]){echo 'selected'; } ?>><?=$row_saka[title_name];?><?=$row_saka[emp_name];?> <?=$row_saka[emp_surname];?></option>
                            <?	} ?>
                          </select>
                      </div>
                  </div>
