...
<div class="col-lg-12">
    <div class="box dark">
		...
		?>
            <form method="post" action="update_mem_no.php" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="mem_id" value="<?=$row[mem_id];?>">
              <h4 class="form-signin-heading" align="center"></h4>
                  <div class="form-group">
                      <label class="control-label col-sm-3">ชื่อผู้สมัคร :</label>
                      <div class="col-sm-5">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <textarea name="mem_detail" class="form-control" rows="3"><?=$row[mem_detail];?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
