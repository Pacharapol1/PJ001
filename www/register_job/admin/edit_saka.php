       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">แก้ไขข้อมูลสาขา</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <?
			$strSQL = "SELECT * FROM saka where saka_id = '".$_GET[saka_id]."' ";
			$stmt  = mysqli_query($conn,$strSQL);
			$row = mysqli_fetch_array($stmt);
		?>
            <form method="post" action="update_saka.php" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" class="form-control" name="saka_id" value="<?=$row[saka_id];?>" required>
              <h4 class="form-signin-heading" align="center"></h4>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <input type="text" class="form-control" placeholder="ชื่อสาขา" name="saka_name" value="<?=$row[saka_name];?>" required>
                      </div>
                  </div>
                  <div class="form-group">
