       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">เพิ่มภาพกิจกรรม</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>กรอกรายละเอียดภาพกิจกรรม</h5>
        </header>
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="add_act.php" class="form-horizontal" enctype="multipart/form-data">
