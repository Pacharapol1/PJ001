       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">เพิ่มข้อมูลสถานประกอบการ</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="add_club.php" class="form-horizontal" enctype="multipart/form-data">
              <h4 class="form-signin-heading" align="center"></h4>
				...
				<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <textarea name="club_office" class="form-control" rows="3"></textarea>
                      </div>
                  </div>
					<div class="form-group">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <input  type="text" class="form-control" placeholder="Email" name="club_email" required>
                      </div>  
                  </div> 
