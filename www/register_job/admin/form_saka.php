       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">เพิ่มข้อมูลสาขา</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="add_saka.php" class="form-horizontal" enctype="multipart/form-data">
              <h4 class="form-signin-heading" align="center"></h4>
                      ...
                      <div class="col-sm-5">
                          <select name="dep_id" class="form-control" required>
                            ...
                            <?
							  ...
							  ?>
                                <option value="<?=$row_dep[dep_id];?>"><?=$row_dep[dep_name];?></option>
                            <?  } ?>
                          </select>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <input type="text" class="form-control" placeholder="ชื่อสาขา" name="saka_name" required>
                      </div>
                  </div>
                  <div class="form-group">
