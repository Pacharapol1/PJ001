       ...
       <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">รายงานการคัดเลือกนักศึกษา</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="exp_report_member.php" class="form-horizontal" enctype="multipart/form-data">
              <h4 class="form-signin-heading" align="center"></h4>
                  ...
                  <!--<div class="form-group">
                      ...
                      <div class="col-sm-3">
                      		<select name="mem_status" class="form-control" required>
                            	<option value="">เลือกสถานะ</option>
                                <option value="all">ทั้งหมด</option>
                                <option value="W">รอชำระเงิน</option>
                                <option value="P">รอตรวจสอบยอดเงิน</option>
                                <option value="Y">อนุมัติเป็นสมาชิก</option>
