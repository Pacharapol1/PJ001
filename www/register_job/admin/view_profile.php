                ...
                <div class="col-lg-12">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            ...
                            <?
								$strSQL = "SELECT * FROM member WHERE emp_id1 = '".$_SESSION["emp_id"]."' or emp_id2 = '".$_SESSION["emp_id"]."' ";
								$stmt  = mysqli_query($conn, $strSQL);
                                    ...
                                    <?
										 ...
										 if($_GET["Action"] == "Del")
										  ...
										  $strSQL = "SELECT * FROM member 
											...
											WHERE member.emp_id1 = '".$_SESSION["emp_id"]."' or member.emp_id2 = '".$_SESSION["emp_id"]."' ";
										  $stmt  = mysqli_query($conn,$strSQL);
