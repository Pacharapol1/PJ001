	   ...
	   <div class="container">
		<div class="col-md-12 detail">
                        ...
                        <div class="panel-body">
                        	<table class="table">
                                  <tbody>
                                      ...
                                      <p>วันที่ : <?=date('d/m', strtotime($result_a[date_ans]));?>/<?=date('Y', strtotime($result_a[date_ans]))+543;?> เวลา :<?=date(' H:i', strtotime($result_a[date_ans]));?> น.</p>
        	...
        	<div class="col-md-6 detail">
                <h1>ตอบคำถาม</h1>
                <form  action="add_answer.php" method="post" class="comment-form">
                ...
                <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                    ...
                    <button class="btn btn-primary" type="submit" >บันทึกคำตอบ</button> 			
                       
                        <button type="button" class="btn btn-danger" onClick="window.location.href = 'list_comment.php'">ยกเลิก</button>
