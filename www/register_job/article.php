	       ...
	       <div class="event-page">
	       	 <div class="row">
	       	 	<div class="col-xs-4 col-sm-4">
	       	 	  <div class="event-img">
	       	 		<a href="view_article.php?article_id=<?=$row_article[article_id];?>"><img src="admin/<?=$row_article[pic];?>" class="img-responsive" alt=""/></a>
	       	 	...
	       	 	<div class="col-xs-8 col-sm-8 event-desc">
	       	 	    ...
	       	 	    <div class="event-info-text">
	       	 		   <div class="event-info-middle"><p style="display:inline;"></p>
       	 				   <p><span class="event-bold"><i class="fa fa-clock-o"></i></span> <?=date('d/m', strtotime($row_article[article_date]));?>/<?=date('Y', strtotime($row_article[article_date]))+543;?></p>
       	 				   <p><?=str_replace("picture/editor/","admin/picture/editor/",substr($row_article['article_detail'],0,900));?>...</p>
                           <p><a href="view_article.php?article_id=<?=$row_article[article_id];?>" ><span class="badge badge-primary">อ่านต่อ >></span></a></p>
	       	 		   </div>
	       	 	    </div>
	       	  </div>
	       	</div>
