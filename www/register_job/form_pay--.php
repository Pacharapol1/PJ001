...
<!-- banner -->
  <div class="courses_banner">
    <div class="container">
      <h3>แจ้งชำระเงินค่าชมรม</h3>
        <div class="breadcrumb1">
            <ul>
                <li class="icon6"><a href="index.php">หน้าหลัก</a></li>
                <li class="current-page">แจ้งชำระเงินค่าชมรม</li>
            </ul>
        </div>
    </div>
   </div>
     ...
     <div class="container">
      ...
      <div class="col-md-9">
         ...
         <div class="panel-body">
                    ...
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">เพิ่มไฟล์เอกสารหน่วยงาน [<?=$row_dep[dep_name];?>]</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="add_doc.php" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="dep_id" value="<?=$_GET[dep_id];?>">
              <h4 class="form-signin-heading" align="center"></h4>
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <select name="tdoc_id" class="form-control" required>
							...
							?>
                            		<option value="<?=$row_td[tdoc_id];?>"><?=$row_td[tdoc_name];?></option>
                            <?	} ?>
                          </select>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          	<input class="form-control" type="text" name="doc_name" required>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <label class="control-label col-sm-3">ประเภทเอกสาร :</label>
                      <div class="col-sm-5">
                          	<input class="form-control" id="fileInput" type="file" name="doc_file" required>
                      </div>
