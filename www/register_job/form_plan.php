     ...
     <div class="container">
      ...
      <div class="col-md-9">
         ...
         <div class="panel-body">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">การบันทึกแผนการปฏิบัติงาน</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="add_plan.php" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="mem_id" value="<?=$_SESSION["mem_id"];?>">
              <h4 class="form-signin-heading" align="center"></h4>
                  ...
                  <div class="form-group">
                      <label class="control-label col-sm-4">หัวข้องาน :</label>
                      <div class="col-sm-8">
                          	<input name="plan_name" class="form-control" placeholder="หัวข้องาน" required>
                      </div>
                      
                  </div>
                  <div class="form-group">
                      <label class="control-label col-sm-4">เดือนที่ :</label>
                      <div class="col-sm-8">
