...
<!-- banner -->
  <div class="courses_banner">
  	<div class="container">
  		<h3>รายงานตัวเข้าปฏิบัติงาน</h3>
        <div class="breadcrumb1">
            <ul>
                <li class="icon6"><a href="index.php">หน้าหลัก</a></li>
                <li class="current-page">รายงานตัวเข้าปฏิบัติงาน</li>
            </ul>
        </div>
  	</div>
  </div>
    ...
    <div class="courses_box1">
     ...
     <?
		$strSQL_re = "SELECT * FROM report where mem_id = '".$_GET[mem_id]."' ";
	...
	<div class="col-md-9">
        ...
        <hr>
        <? if($numre == ''){ ?>
	   	  <form method="post" class="form-horizontal" action="add_report.php">
          <input type="hidden" class="form-control" name="mem_id" value="<?=$_GET[mem_id];?>" required>
          <input type="hidden" class="form-control" name="re_id" value="<?=$_GET[re_id];?>" required>
              <h4 class="form-signin-heading" align="center">รายละเอียดเกียวกับที่พักระหว่างปฏิบัติงาน</h4>
              	<div class="form-group">
                    ...
                    <div class="col-sm-8">
                          <input type="text" class="form-control" placeholder="ที่อยู่" name="re_add" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-3">ตำบล :</label>
                    <div class="col-sm-8">
                          <input type="text" class="form-control" placeholder="ตำบล" name="re_tam" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-3">อำเภอ :</label>
                    <div class="col-sm-8">
                          <input type="text" class="form-control" placeholder="อำเภอ" name="re_aum" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                          <input type="text" class="form-control" placeholder="รหัสไปรษณีย์" name="re_zip" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                          <input type="text" class="form-control" placeholder="เบอร์ติดต่อ" name="re_mobile" required>
                    </div>
                </div>
              ...
              <input type="hidden" class="form-control" name="re_id" value="<?=$_GET[re_id];?>" required>
                  <h4 class="form-signin-heading" align="center">รายละเอียดเกียวกับที่พักระหว่างปฏิบัติงาน</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                             <?
								$sql_prov = "SELECT * FROM provinces where prov_id = '".$row_re[prov_id]."' ";
								$stm_prov = mysqli_query($conn,$sql_prov);
								$row_prov = mysqli_fetch_array($stm_prov);
								echo $row_prov[prov_name];
							  ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <label class="control-label col-sm-3"></label>
                            <a href="print_re.php?re_id=<?=$_GET[re_id];?>" class="btn btn-primary" target="_blank">พิมพ์</a> 
                            <a href="edit_re.php?re_id=<?=$row_re[re_id];?>&rew_id=<?=$_GET[re_id];?>" class="btn btn-warning">แก้ไข</a>
                            </div>
                      </div>
                </form>
            <? } ?>
