      ...
      <h3>เพิ่มตำแหน่งงาน</h3>
        <div class="breadcrumb1">
            <ul>
                ...
                <li class="current-page">เพิ่มตำแหน่งงาน</li>
            </ul>
        </div>
    </div>
   </div>
     ...
     <div class="container">
      ...
      <div class="col-md-9">
         ...
         <div class="panel-body">
                    <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">เพิ่มตำแหน่งงาน</h2>
                </div>
            </div>
...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form method="post" action="add_work.php" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="club_id" value="<?=$_SESSION["club_id"];?>">
              <h4 class="form-signin-heading" align="center"></h4>
                  <div class="form-group">
              	  ...
              	  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                      		<input name="work_name" class="form-control" type="text" placeholder="ตำแหน่งงาน" required>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="control-label col-sm-3">รายละเอียดงาน :</label>
                      <div class="col-sm-8">
                          	<textarea name="work_detail" class="form-control" rows="5" placeholder="รายละเอียดงาน" required></textarea>
                      </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          	<input name="work_num" class="form-control" type="number" min="1" placeholder="0" required>
                      </div>
