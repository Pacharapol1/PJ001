...
<!-- banner -->
  <div class="courses_banner">
	...
	<div class="courses_box1">
	   <div class="container">
       <div class="col-lg-6">
	   	  <form method="post" action="ChkLog_office.php">
	    	<p class="lead">เข้าสู่ระบบ (สำหรับผู้ประกอบการ)</p>
		    <div class="form-group">
			    <input autocomplete="off" type="text" name="user" class="form-control" placeholder="Email" required>
		    </div>
		    <div class="form-group">
