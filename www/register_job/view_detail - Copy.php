	...
	<div class="courses_box1">
	   <div class="container">
		...
		<div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="col-md-2">สิทธิการใช้งาน : </label>
					<?
						if($row[emp_type] == 1){
							echo 'ผู้ดูและระบบ';
                ...
                <? 
					...
					<a href="JavaScript:if(confirm('ยืนยันอนุมัติการลา ?')==true){window.location='<?=$_SERVER["PHP_SELF"];?>?Action=Yesconhead&id=<?=$row["id"];?>';}"  class="btn btn-success">อนุมัติ</a>&nbsp;
